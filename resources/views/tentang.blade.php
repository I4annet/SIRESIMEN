...
<head>
    ...
    <style>
        body {
            ...
            .card {
                @apply bg-white/10 backdrop-blur-lg rounded-2xl border border-[#FFD700]/30 p-8 transition-all duration-300 hover:shadow-2xl hover:shadow-[#FFD700]/30;
            }

            .btn-primary {
                @apply bg-[#FFD700] text-[#2F4F4F] font-semibold px-8 py-3 rounded-full hover:bg-[#FFE873] transition-all duration-300 transform hover:-translate-y-0.5 hover:shadow-lg;
            }

            .btn-outline {
                @apply border-2 border-[#FFD700] text-white font-medium px-8 py-3 rounded-full hover:bg-[#FFD700] hover:text-[#2F4F4F] hover:bg-opacity-20 transition-all duration-300 transform hover:-translate-y-0.5;
            }

            .feature-icon {
                @apply w-16 h-16 rounded-2xl bg-gradient-to-br from-[#FFD700] to-[#4B0082] flex items-center justify-center text-2xl mb-6 mx-auto;
            }
        ...
        <header class="fixed top-0 w-full p-4 bg-[#36441e] border-b border-[#FFD700] z-50 transition-all duration-300" id="header">
            <nav class="flex justify-between items-center max-w-screen-xl mx-auto">
                ...
                <ul class="nav-links hidden md:flex gap-8 list-none">
                    ...
                    <li><a href="tentang.blade.php" class="text-white text-lg font-medium hover:-translate-y-0.5 relative">Tentang</a></li>
